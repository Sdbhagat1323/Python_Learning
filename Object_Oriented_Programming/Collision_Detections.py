# Collision_Detection
# If the distance between two blobs are is less than there sumed radius they must be touching.
# to do this we need norm ( norm == euclidion_distances)
...
# blue_blob + red_blob
# Handling of blob interactions or touching each others
class BlueBlob(Blob):
